...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-tasks fa-fw"></i> Manage Categories<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL('admin/categories') }}">All Categories</a>
                                </li>
                                <li>
                                    <a href="{{ URL('admin/categories/create') }}">Create Categorie</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-file-text-o fa-fw"></i> Manage Lessons<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL('admin/lessons') }}">All Lessons</a>
                                </li>
                                <li>
                                    <a href="{{ URL('admin/lessons/create') }}">Create Lesson</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-font fa-fw"></i> Manage Words<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL('admin/words') }}">All Words</a>
                                </li>
                                <li>
                                    <a href="{{ URL('admin/words/create') }}">Create Words</a>
                                </li>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.2.1/raphael.no-deps.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/startbootstrap-sb-admin-2/3.3.7+1/js/sb-admin-2.js"></script>
